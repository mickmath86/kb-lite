...
function Chip({ children, accent = false }: { children: React.ReactNode; accent?: boolean }) {
  return (
    <span className={clsx(
      ...
      accent ? 'bg-white text-olive-950' : 'bg-white/10 text-white'
    )}>
      {children}
    </span>
  )
          ...
          <div>
            ...
            {info.siteUrl && (
              <p className="mt-1.5 text-xs text-white/35">
                A live preview slide will appear right after this screen. Note: some sites block embedding — a fallback link is shown if so.
              </p>
            )}
          </div>
          <div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Slide 2 — Kickbord homepage preview
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="relative flex h-full w-full overflow-hidden bg-olive-950">
      ...
      <div className="absolute top-0 inset-x-0 z-10 flex shrink-0 items-center justify-between gap-4 border-b border-white/10 px-6 py-3">
        <div className="flex items-center gap-3">
          <span className="font-mono text-xs font-semibold uppercase tracking-widest text-white/40">What we build</span>
          <span className="rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-white">kickbord.com</span>
        </div>
        <div className="flex items-center gap-3">
      ...
      {/* iframe */}
      <iframe
        src="https://kickbord.com"
        className="flex-1 w-full border-0 pt-[52px]"
        title="Kickbord homepage"
...
// ─────────────────────────────────────────────────────────────────────────────
// Slide 3 — The System (from original Slide 9)
// ─────────────────────────────────────────────────────────────────────────────
      ...
      <div className="w-full max-w-7xl">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center">
          ...
          <div className="relative overflow-hidden rounded-2xl border border-olive-950/10 bg-olive-950/5 dark:border-white/10 dark:bg-white/5">
            {/* Placeholder visual — form + SMS mockup */}
            <div className="flex flex-col items-center justify-center gap-8 p-10 min-h-[420px]">
              ...
              <div className="w-full max-w-xs rounded-2xl border border-olive-950/15 bg-white p-5 shadow-lg dark:border-white/15 dark:bg-white/10">
                ...
                <div className="flex flex-col gap-2">
                  <div className="self-end rounded-2xl rounded-br-sm bg-olive-700 px-3 py-2 max-w-[80%]">
                    <p className="text-xs text-white">{`New lead from ${info.company || 'your site'}! Carlos A. — call or text (805) 555-0199`}</p>
                  </div>
              ...
              <p className="text-xs text-olive-500 dark:text-olive-400 text-center">
                [Image placeholder — will be updated with live demo screenshot]
              </p>
            </div>
          </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Slide 5 — AI Chatbot demo embed (kickbord.com/chatdemo)
// ─────────────────────────────────────────────────────────────────────────────
          ...
          <div className="relative flex min-h-[400px] items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/5">
            ...
            <div className="flex flex-col gap-4 p-8 w-full max-w-sm">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="self-end max-w-[85%] rounded-2xl rounded-tr-sm bg-olive-600 px-3.5 py-2.5">
                  <p className="text-xs text-white">Sure, its Mike — 805-555-0100</p>
                </div>
                <div className="self-start max-w-[85%] rounded-2xl rounded-tl-sm bg-white/15 px-3.5 py-2.5">
              ...
              <p className="text-center text-xs text-white/30">[Image placeholder — live chatbot demo]</p>
            </div>
          </div>
      ...
      <div className="w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          {features.map((f) => (
            <div
              key={f.title}
              className="relative flex items-start gap-5 rounded-2xl border border-olive-950/10 bg-white p-7 dark:border-white/10 dark:bg-white/5"
            >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div className="rounded-2xl border border-olive-950/10 bg-white p-8 dark:border-white/10 dark:bg-white/5">
              ...
              <div className="mt-5 rounded-lg bg-olive-950/5 px-4 py-2 dark:bg-white/5">
              ...
              <a
                href="/get-started"
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-olive-950 py-3 text-sm font-semibold text-white transition hover:bg-olive-800 dark:bg-white dark:text-olive-950 dark:hover:bg-white/90"
              >
                Get started →
              </a>
            </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Slide 9 — Upsell (LSA + Reputation Management)
// ─────────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden bg-olive-950 px-8 py-16">
      ...
      <div className="relative z-10 w-full max-w-5xl">
        <div className="mb-10 text-center">
          <Eyebrow light>Want to go further?</Eyebrow>
          <SlideHeadline light className="mt-3 text-4xl sm:text-5xl">
            More leads. More reviews.<br />More visibility.
          </SlideHeadline>
          <p className="mt-4 text-lg/8 text-white/70 max-w-xl mx-auto">
            Once your core system is running, these two add-ons supercharge your growth.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          {/* LSA */}
          <div className="flex flex-col gap-5 rounded-2xl border border-white/15 bg-white/8 p-7">
            <div className="flex items-start gap-4">
              <span className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-white/15 text-white">
                <MapPinIcon />
              </span>
              <div>
                <p className="text-base font-semibold text-white">Local Services Ads</p>
                <p className="mt-0.5 text-xs font-semibold uppercase tracking-widest text-white/40">Google Guaranteed</p>
              </div>
            </div>
            <p className="text-sm/6 text-white/70">
              Get your business at the very top of Google search — above regular ads and the map pack. LSA shows your name, rating, and a direct call button to homeowners actively searching for your services.
            </p>
            <ul className="flex flex-col gap-2">
              {[
                'Pay per verified lead — not per click',
                'Google Guaranteed badge builds instant trust',
                'Managed setup and ongoing optimisation',
                `${company} only pays for real phone calls`,
              ].map((item) => (
                <li key={item} className="flex items-start gap-2.5 text-xs text-white/70">
                  <span className="mt-0.5 size-3.5 shrink-0 text-white/40"><CheckmarkIcon /></span>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <div className="flex flex-col gap-5 rounded-2xl border border-white/15 bg-white/8 p-7">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-base font-semibold text-white">Reputation Management</p>
                <p className="mt-0.5 text-xs font-semibold uppercase tracking-widest text-white/40">Automated reviews</p>
              </div>
            </div>
            <p className="text-sm/6 text-white/70">
              After every completed job, your customers automatically get a review request link sent to their phone. No awkward ask. No relying on people to remember. You build reviews consistently on autopilot.
            </p>
            <ul className="flex flex-col gap-2">
              {[
                'Automated post-job review request SMS',
                'Directs customers to Google, Yelp, or both',
                'More reviews = better local ranking',
                'Builds social proof without extra effort',
              ].map((item) => (
                <li key={item} className="flex items-start gap-2.5 text-xs text-white/70">
                  <span className="mt-0.5 size-3.5 shrink-0 text-white/40"><CheckmarkIcon /></span>
                  {item}
        ...
        <p className="mt-6 text-center text-xs text-white/35">Both add-ons are included in Kickbord Grow — or available à la carte.</p>
      </div>
    </div>
  )
}
      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href="/get-started"
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-white py-3 text-sm font-semibold text-olive-950 transition hover:bg-white/90"
            >
    ...
    <div className="flex h-full w-full flex-col items-center justify-center px-8 py-16 bg-white dark:bg-olive-950">
      <div className="w-full max-w-5xl">
        <div className="mb-10 text-center">
          ...
          <SlideHeadline className="mt-3 text-4xl sm:text-5xl">Choose your starting point.</SlideHeadline>
          <SlideSubhead className="mx-auto mt-4 max-w-xl">
            Both plans include the full core system. Grow adds more reach and reputation.
          </SlideSubhead>
        </div>

        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          {/* Launch */}
          <div className="relative flex flex-col gap-5 rounded-2xl border border-olive-950/10 bg-white p-7 dark:border-white/10 dark:bg-white/5">
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-olive-500">Launch</p>
              <div className="mt-1 flex items-baseline gap-1">
                <span className="font-display text-5xl text-olive-950 dark:text-white">$297</span>
                <span className="text-olive-500">/mo</span>
              </div>
              <p className="mt-2 text-sm text-olive-600 dark:text-olive-400">The complete system to capture and convert leads.</p>
            </div>
            <ul className="flex flex-col gap-2">
              {launchFeatures.map((f) => <CheckItem key={f}>{f}</CheckItem>)}
            </ul>
            <a
              href="/get-started"
              className="mt-auto flex w-full items-center justify-center gap-2 rounded-xl border border-olive-950/20 bg-white py-3 text-sm font-semibold text-olive-950 transition hover:bg-olive-950/5 dark:border-white/20 dark:bg-white/5 dark:text-white dark:hover:bg-white/10"
            >
              Start with Launch
            </a>
          </div>
          ...
          {/* Grow */}
          <div className="relative flex flex-col gap-5 rounded-2xl border-2 border-olive-950 bg-olive-950 p-7 dark:border-white/30">
            <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-olive-950 px-4 py-1 text-xs font-bold text-white dark:bg-white dark:text-olive-950">Most Popular</span>
            <div>
              <p className="text-xs font-semibold uppercase tracking-widest text-olive-400">Grow</p>
              <div className="mt-1 flex items-baseline gap-1">
                <span className="font-display text-5xl text-white">$497</span>
                <span className="text-white/50">/mo</span>
              </div>
              <p className="mt-2 text-sm text-white/70">Everything in Launch, plus LSA and reputation.</p>
            </div>
            <ul className="flex flex-col gap-2">
              {launchFeatures.map((f) => <CheckItem key={f} light>{f}</CheckItem>)}
              <li className="mt-1 border-t border-white/10 pt-3">
                <p className="mb-2 text-xs font-semibold uppercase tracking-widest text-white/40">Also included:</p>
              </li>
              {growExtras.map((f) => (
                <li key={f} className="flex items-start gap-3 text-sm/6 text-olive-300">
            ...
            <a
              href="/get-started"
              className="mt-auto flex w-full items-center justify-center gap-2 rounded-xl bg-white py-3 text-sm font-semibold text-olive-950 transition hover:bg-white/90"
            >
              Start with Grow →
            </a>
          </div>
...
// ─────────────────────────────────────────────────────────────────────────────
// Slide 12 — Quarterly incentives with tab switcher
// ─────────────────────────────────────────────────────────────────────────────
...
function Slide12({ info }: { info: LeadInfo }) {
  ...
  const plans = [
    {
      ...
      key: 'launch',
      monthly: { price: '$297', period: '/mo', cta: 'Start Launch monthly', href: '/get-started?plan=launch&billing=monthly' },
      quarterly: {
        price: '$800',
        period: '/qtr',
        savings: 'Save $91',
        ...
        bonus: 'Setup fee waived or reduced',
      },
    ...
    },
    {
      name: 'Kickbord Grow',
      key: 'grow',
      monthly: { price: '$497', period: '/mo', cta: 'Start Grow monthly', href: '/get-started?plan=grow&billing=monthly' },
      quarterly: {
        price: '$1,340',
        period: '/qtr',
        savings: 'Save $151',
        ...
        bonus: 'Setup fee waived + priority onboarding',
      },
      color: 'dark' as const,
    },
  ]
  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center px-8 py-16 bg-white dark:bg-olive-950">
      <div className="w-full max-w-5xl">
        <div className="mb-10 text-center">
          <Eyebrow>Quarterly incentives</Eyebrow>
          <SlideHeadline className="mt-3 text-4xl sm:text-5xl">Better value when you commit.</SlideHeadline>
          <SlideSubhead className="mx-auto mt-4 max-w-xl">
            Pay quarterly and get 10% off plus bonus perks — setup fee waived or reduced.
          </SlideSubhead>

          {/* Tab switcher */}
          <div className="mt-8 inline-flex rounded-full border border-olive-950/15 bg-olive-950/5 p-1 dark:border-white/15 dark:bg-white/5">
            <button
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                {isDark && <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 rounded-full bg-olive-950 px-4 py-1 text-xs font-bold text-white dark:bg-white dark:text-olive-950">Most Popular</span>}
                <div>
                ...
                {billingTab === 'quarterly' && 'bonus' in data && (
                  <div className={clsx('rounded-xl p-3.5', isDark ? 'bg-white/10 border border-white/15' : 'bg-olive-950/5 border border-olive-950/10 dark:bg-white/5 dark:border-white/10')}>
        ...
        <p className="mt-6 text-center text-xs text-olive-500 dark:text-olive-400">
          All plans include full onboarding and setup. Quarterly billing locks in your rate for 3 months.
        </p>
      </div>
    </div>
  )
...
// ─────────────────────────────────────────────────────────────────────────────
// Conditional — Live site preview (shown only if siteUrl provided)
// ─────────────────────────────────────────────────────────────────────────────
...
export default function ContractorPitchDeck() {
  ...
  // Inject prospect's site preview as the first slide if siteUrl provided
  const hasPreview = Boolean(info.siteUrl)
  const slideLabels = hasPreview
    ? ['Current Site Preview', ...BASE_LABELS]
    : BASE_LABELS
  const slideComponents = hasPreview
    ? [SitePreviewSlide, ...BASE_COMPONENTS]
    : BASE_COMPONENTS
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-mist-100 dark:bg-mist-950">
      ...
      {menuOpen && (
        ...
        >
          <div
            className="max-h-[80vh] w-full max-w-sm overflow-y-auto rounded-2xl bg-white p-4 shadow-2xl dark:bg-olive-900"
